...
export function convertIeltsListeningRawToBand(rawScore) {
  if (typeof rawScore !== 'number' || Number.isNaN(rawScore) || !Number.isInteger(rawScore) || rawScore < 0 || rawScore > 40) {
    throw new Error(`Invalid IELTS raw score: ${rawScore}. Must be an integer between 0 and 40.`);
  }
