# Stage 2 Wave W2 Corrected Prospective Current-Code Revalidation Record

Record Identity: **STAGE2-W2-IELTS-LIS-REVALIDATION-002**  
Transaction ID: **W2-GOV-REVALIDATION-002**  
...
Canonical Predecessor (Base): **`f76b8a1bf624c9571f462ad07dc2349dbfac735c`**  
...
### 1.1 Canonical Recovery Predecessor Chain
- **Successor Authorization:** `STAGE2-W2-IELTS-LIS-AUTH-002` (PR #122, accepted via review `4947368105`, merged at `0d7acbf0c6f056c3f169e2200e58f785f8e2e3d9`).
- **Replacement Activation:** `AGENT_CONTEXT_AUTH_ACTIVATION_V1 — W2-IELTS-LIS-001` (PR #123, accepted via review `4947382360`, merged at `d278f2045b38299b056f16ec7d76fb81c0739541`).
- **First Recovery Authorization:** `STAGE2-W2-IELTS-LIS-RECOVERY-AUTH-001` (PR #127, accepted via review `4948153412`, merged at `9b728437a61a3ed5880d4c0863a213a5b6dd87bb`).
- **Provenance Recovery Authorization:** `STAGE2-W2-IELTS-LIS-PROVENANCE-RECOVERY-AUTH-001` (PR #130, accepted via review `4948240950`, merged at `f76b8a1bf624c9571f462ad07dc2349dbfac735c`).

### 1.2 Superseded Historical Revalidation Record (PR #128)
- **Historical PR #128 (`STAGE2-W2-IELTS-LIS-REVALIDATION-001`):** Merged at `26a568307b35d14e53570079276b20406f5daccf`. Its candidate document contained a typographical non-existent commit string (`9b72843b0923d387349910c22faeb9f3152d06ea`) for PR #127. Its semantic revalidation acceptance is superseded with respect to exact provenance validity and replaced by this record (`STAGE2-W2-IELTS-LIS-REVALIDATION-002`).

### 1.3 Historical Non-Compliant Execution Ledger (PR #125 & PR #126)
- **Historical PR #125 (`exec/stage2-w2-ielts-lis-recovery-002`):**
  ...
  - Actual Commit Topology: **3 Substantive Commits (`A -> B -> C`)**:
    1. Commit A (`a6a6d8e9de97b1a6845111a5f930cfc50a4b4538`): Tests only. Natural RED CI run `31974833396` (`990 pass / 2 fail`).
    2. Commit B (`926a9ef7651d1f15367ad1f7d2c50d101b465443`): Implementation. Natural CI run `31975024526` failed on browser smoke assertion `4 !== 3`.
    3. Commit C (`900405f39badaaf4fdfd0441ed9a05451ade34eb`): Refined IELTS Hub containment. Natural GREEN CI run `31975164283` (`success`).
  - Pre-Merge Independent Review: **ABSENT** on GitHub (0 reviews in API).
  - Implementation Merge SHA: `3c90ebd10b9559c8ec2090a3226c7b8d11cd092f` (Status: `MERGED_WITH_GOVERNANCE_VIOLATION`).
...
- **Historical PR #126 (`docs/stage2-w2-status-reconciliation-001`):**
  ...
  - Pre-Merge Independent Review: **ABSENT** on GitHub (0 reviews in API).
  - Merge SHA: `4e83d38c4db8fdfda6cfaba6c176231942dabb12` (Status: `PREMATURE_STATUS_CLOSURE`).
...
The Independent Auditor must fresh-inspect the current retained code on `main` against controlling specifications in `STAGE2-W2-IELTS-LIS-AUTH-002.md` and Owner-ratified decisions D01, D02, D03:
