# W6-P7-00-WKN-AUTH-005: Wave 6 P7-00/WKN-00 Authorization Manifest

Authorization ID: `W6-P7-00-WKN-AUTH-005`
Execution Record: `W6-P7-00-WKN-EXEC-005`
...
|---|---|
| 1. wave/package identity | W6-P7-00-WKN-EXEC-005 (P7-00/WKN-00) |
...
| 18. evidence path | `docs/superpowers/specs/2026-08-12-wave-6-p7-00-wkn-exec-005-evidence.md` |
...
- **Commit C (implementer evidence)**: May modify ONLY `docs/superpowers/specs/2026-08-12-wave-6-p7-00-wkn-exec-005-evidence.md`.
...
Evidence Path: `docs/superpowers/specs/2026-08-12-wave-6-p7-00-wkn-exec-005-evidence.md`
...
- `authorization_id`: `W6-P7-00-WKN-AUTH-005`
- `execution_record_id`: `W6-P7-00-WKN-EXEC-005`
