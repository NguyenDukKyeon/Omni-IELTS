...
Recovery lineage:
REPLACEMENT_FOR_BLOCKED_CANDIDATES
...
Blocked manifest tree:
1e93ab2ead5a028428838f4af1f8d257f2386c07
Blocked manifest blob:
07f3f8f8da6040afa68e5f6ea62fb6ff822e6052
Blocked exact-head CI:
natural pull_request run absent
workflow-specific run absent
check-run absent
commit status absent
job not created
runner not assigned
zero executed steps
zero artifacts
...
continue, repair or override the failed exact-head gates of
W1-AUTH-MANIFEST-001 or W1-AUTH-MANIFEST-002. PR #30 and PR #31 remain
historical, Draft, open, unmerged and unchanged. This V3 record uses a
preparatory Commit A only to establish its Draft PR topology. Commit A is not
an audit subject and has no executable gate. Only the substantive Commit B
created after the Draft PR exists is the final candidate. This record has no
effect unless exact Commit B receives natural pull_request CI success with all
five required artifacts and an independent exact-head ACCEPT.

V3 authoring topology:
Commit A:
PREPARATORY_HEAD / NOT_AUDIT_SUBJECT
Commit A purpose:
establish the V3 Draft PR before the final candidate head exists
Commit A CI:
historical if present
not required
not acceptance evidence
absence is not a failed V3 gate
Commit B:
...
- PR #31 owns the historical blocked W1-AUTH-MANIFEST-002 candidate at exact
  ...
  provenance for V3. It is not an effective manifest, active writer, successful
  CI subject or merge candidate. V3 uses a distinct path and record identity.
...
no PR #30 mutation
blocked PR #31 identity frozen
blocked V2 zero-run and zero-check state frozen
V3 branch and PR absence verified before creation
V3 Commit A classified preparatory and non-auditable
V3 Commit B frozen as sole final candidate
no Commit A result reused as Commit B evidence
no PR #30 mutation
no PR #31 mutation
```
