...
Recovery lineage:
NEW_INDEPENDENTLY_AUDITABLE_POST_INCIDENT_RECORD

Historical blocked manifest record:
W1-AUTH-MANIFEST-001

Historical blocked pull request:
30

Historical blocked branch:
chatgpt/w1-bounded-execution-manifest-v1

Historical blocked exact head:
61690e56649474727befbd1d8de5ae4bbc4af160

Historical blocked manifest blob:
eabdfb079871e7c9aff67f2fb795327400d61a05

Historical blocked classification:
BLOCKED / HOSTED_RUNNER_NOT_ACQUIRED
...
Historical blocked branch:
chatgpt/w1-bounded-execution-manifest-v2

Historical blocked exact head:
2ba130335bfa8ac1ef27359a59869f8fc6708efd

Historical blocked manifest tree:
1e93ab2ead5a028428838f4af1f8d257f2386c07

Historical blocked manifest blob:
07f3f8f8da6040afa68e5f6ea62fb6ff822e6052

Historical blocked classification:
BLOCKED / EXACT_HEAD_NATURAL_CI_ABSENT

Historical blocked manifest record:
W1-AUTH-MANIFEST-003

Historical blocked pull request:
32

Historical blocked branch:
chatgpt/w1-bounded-execution-manifest-v3

Historical blocked exact head:
b330f76584c4dce837d56610ac55016e0f80f2e3

Historical blocked manifest tree:
89c2ae0ee46f0423040c92972d49e09670b45381

Historical blocked manifest blob:
c75ff82b5eba6577c0aacf7dd7bae1ea5f9a2ad5

Historical blocked verdict:
BLOCKED

Historical blocked reason:
EXACT_HEAD_NATURAL_CI_ABSENT

Infrastructure incident lineage:
GITHUB_ACTIONS_INCIDENT:
qcvjkzcs7j74
INCIDENT_STATE_BEFORE_V4:
RESOLVED
MISSED_EVENT_REPLAY:
NOT_AVAILABLE
ACTIONS_COMPONENT_BEFORE_V4:
OPERATIONAL
WEBHOOKS_COMPONENT_BEFORE_V4:
OPERATIONAL
UNRESOLVED_GITHUB_STATUS_INCIDENTS_BEFORE_V4:
NONE
WEBHOOK_TRIGGERED_ACTIONS_BEFORE_V4:
RESTORED / FULL_THROUGHPUT
HOSTED_RUNNER_ACTIVE_INCIDENT_BEFORE_V4:
NONE_REPORTED

V4 infrastructure preflight rule:
No V4 mutation may begin while an official Actions incident affecting
webhook-triggered workflows or runner processing is active. GitHub Status must
show the Actions component operational, no unresolved incident affecting the
required trigger path, and no current Actions incident reporting degraded
hosted-runner assignment or queue processing.

Recovery rule:
This is a new independently auditable manifest record. It does not reuse,
continue, repair, revive or override the failed exact-head gates of
W1-AUTH-MANIFEST-001, W1-AUTH-MANIFEST-002 or W1-AUTH-MANIFEST-003. PR #30,
PR #31 and PR #32 remain historical, Draft, open, unmerged and unchanged. V4
uses a new branch, path, Draft PR and exact-head record. Commit A establishes
the Draft PR topology only. Commit A is not an audit subject and has no
acceptance gate. Only the substantive Commit B created after the Draft PR
exists is the final candidate. No event or evidence from an earlier manifest
candidate may satisfy a V4 final-head gate.

V4 authoring topology:
Commit A:
PREPARATORY_HEAD / NOT_AUDIT_SUBJECT / NOT_ACCEPTANCE / NOT_EXECUTABLE
Commit A purpose:
create the V4 manifest file and establish the V4 Draft PR before the final
candidate head exists
Commit A CI:
historical if present
not required
not acceptance evidence
may not satisfy any Commit B gate
Commit B:
FINAL_EXACT_HEAD / SOLE_AUDIT_SUBJECT
Commit B creation rule:
only after the Draft PR exists and the pre-Commit-B infrastructure race gate
passes
...
historical blocked replacement PR: #31
historical blocked replacement head: 2ba130335bfa8ac1ef27359a59869f8fc6708efd
historical blocked replacement blob: 07f3f8f8da6040afa68e5f6ea62fb6ff822e6052
historical blocked synchronize PR: #32
historical blocked synchronize head: b330f76584c4dce837d56610ac55016e0f80f2e3
historical blocked synchronize tree: 89c2ae0ee46f0423040c92972d49e09670b45381
historical blocked synchronize blob: c75ff82b5eba6577c0aacf7dd7bae1ea5f9a2ad5
V4 manifest branch before creation: ABSENT
V4 manifest PR before creation: ABSENT
V4 manifest path before creation: ABSENT
workflow ID: 322561862
workflow path: .github/workflows/ci.yml
workflow blob: 6482c8a54f539cddff0fb772fdc849a1ffdee162
workflow state: active
GitHub Actions incident qcvjkzcs7j74: RESOLVED
Actions component: OPERATIONAL
Webhooks component: OPERATIONAL
unresolved GitHub Status incidents: NONE
```
...
- PR #30 owns the historical blocked W1-AUTH-MANIFEST-001 candidate at exact
  ...
  successful CI subject or merge candidate. V4 uses a distinct path and record
  identity.
- PR #31 owns the historical blocked W1-AUTH-MANIFEST-002 candidate at exact
  head `2ba130335bfa8ac1ef27359a59869f8fc6708efd` and exact blob
  `07f3f8f8da6040afa68e5f6ea62fb6ff822e6052`. It is immutable historical
  provenance for V4. It is not an effective manifest, active writer, successful
  CI subject or merge candidate. V4 uses a distinct path and record identity.
- PR #32 owns the historical blocked W1-AUTH-MANIFEST-003 candidate at exact
  head `b330f76584c4dce837d56610ac55016e0f80f2e3`, exact tree
  `89c2ae0ee46f0423040c92972d49e09670b45381` and exact blob
  `c75ff82b5eba6577c0aacf7dd7bae1ea5f9a2ad5`. Its verdict is `BLOCKED` with
  reason `EXACT_HEAD_NATURAL_CI_ABSENT`. It is immutable historical provenance
  for V4, remains Draft/open/unmerged/unchanged and is not a V4 CI subject.

Wave 1 records do not write any path owned by PR #26, #27 or #28. V4 writes no
path owned by PR #30, #31 or #32. LI-00 owns the frozen Run and
terminal-settlement seam in Today Runner, not Today composition. Exact-path
separation is supplemented by semantic-owner separation.
...
open PR pagination complete
open PR overlap checked
LI and SRC semantic non-overlap proven
historical PR #30 identity frozen
historical PR #31 identity frozen
historical PR #32 identity frozen
historical V1 runner-not-acquired state preserved
historical V2 exact-head natural CI absence preserved
historical V3 exact-head natural CI absence preserved
V3 final blob c75ff82b5eba6577c0aacf7dd7bae1ea5f9a2ad5 used as semantic source
Moonshine comparison span textually unchanged from V3 final blob
GitHub Actions incident qcvjkzcs7j74 resolved before V4
Actions component operational before V4
Webhooks component operational before V4
no unresolved GitHub Status incident before V4
workflow 322561862 active and unchanged
V4 branch absence verified before creation
