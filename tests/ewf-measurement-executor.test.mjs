...
const negativeCases = {
  ...
  'ME-N25': () => {
    const comments = syntheticComments({ missingSecond: true }); expectCode(() => validateJournalAndSeal({ comments, sealComment: sealFor(missing), requestPR: 40, requestHeadSha: R, attemptId: SAT_ATTEMPT_ID }), 'JOURNAL_INCOMPLETE');
  },
  'ME-N26': () => {
