...
test('every durable store sentinel reaches canonical vNext payload while caches and capabilities stay out',async()=>{
  ...
  assert.deepEqual(first.domains.v10.stores.meta.map(row=>row.key),['lexical-migration-v1','phase1:migration:p1-00-v10-opener-v1','phase1:migration:p1-03-v10-workflow-intents-v2','phase1:migration:p1-05-v10-transcript-aggregate-v3','phase1:migration:p1-06-v10-global-errors-v4','phase1:migration:p1-08-v10-today-runs-v5','phase1:migration:p2-01-v10-resolver-jobs-v6']);
